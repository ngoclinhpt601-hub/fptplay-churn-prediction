...
# ============================================================================
# PREDICTION FUNCTION (WITH SKLEARN COMPATIBILITY FIX)
# ============================================================================
...
def predict_churn(customer_data, model_info):
    ...
    try:
        ...
        # Predict với sklearn compatibility fix
        model = model_info['model_object']
        
        # Fix sklearn compatibility issue - patch monotonic_cst attribute
        ...
        # Fallback: Manual prediction using tree voting
        try:
...
def main():
    ...
    if predict_button:
        ...
        if result is None:
            st.error("❌ Không thể thực hiện dự đoán. Vui lòng kiểm tra lại dữ liệu.")
            return
